...
import type { MisspelledRange, ResultResponse, SpellRequest } from "./spellcheck-worker.js";
...
const check = async (pieces: Array<{ from: number; text: string }>): Promise<MisspelledRange[]> => {
